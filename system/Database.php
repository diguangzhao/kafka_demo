...
class Database
{
    ...
    public static function db($name = null)
    {
        ...
        if (!isset(self::$DB[$name])) {
            ...
            if (is_string($opt)) {
                ...
                $db = \Dea\IoC::construct('\Dea\Database', $opt['dsn'], $opt['username'], $opt['password'], $opt['options']);
            }
    ...
    public function __construct($dsn, $username = null, $password = null, $options = null)
    {
        ...
        $driver_class = '\Dea\Database\\'.$driver_name;
        $this->_driver = \Dea\IoC::construct($driver_class, $dsn, $username, $password, $options);
    ...
    public function query($SQL, $idents = null, $params = null)
    {
        ...
        if (is_array($params)) {
            ...
            \Dea\Logger::of('core')->debug('Database query execute = {params}', ['params' => J($params)]);
    ...
    {
        \Dea\Logger::of('core')->debug('Database exec = {SQL}', [
